...
// let id_message = document.querySelector("#id_message")
// id_message.classList.add("header_textarea")
// let option = document.querySelector("#id_contact_type")
// let id_message = document.querySelector("#id_message")
// window.addEventListener("load", () => {
//     option.classList.add("header_select")
//     id_message.classList.add("header_textarea")
// })